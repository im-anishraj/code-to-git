...
### Website Content
The extension reads content from `leetcode.com` specifically to extract your accepted code submissions, problem titles, and difficulty levels. This data is temporarily processed in your browser to format it and is then pushed directly to your personal GitHub repository.

## 2. How We Use Information
- **GitHub Token**: Used solely to push your LeetCode solutions to the GitHub repository you specify.
- **LeetCode Submissions**: Used solely to synchronize your coding progress to your GitHub account.

## 3. Data Sharing and Disclosure
We **do not** sell, trade, or otherwise transfer your data to outside parties. Your code and authentication tokens are never sent to any analytics services, trackers, or developer-owned servers.

## 4. Third-Party Services
The extension communicates with:
- **GitHub API**: To authenticate and push code. (See [GitHub Privacy Statement](https://docs.github.com/en/site-policy/privacy-policies/github-privacy-statement))
